      ...
      <table width="100%" border="0" align="center" class="table">
        ...
        ?>
          ...
          <tr>
            ...
            <td><a href="formularioP.php?referencia=<?php echo $reg['referencia']; ?>&nombre=<?php echo $reg['nombre']; ?>&descripcion=<?php echo $reg['descripcion']; ?>&precio=<?php echo $reg['precio']; ?>&descuento=<?php echo $reg['descuento']; ?>">
