      ...
      <form action='preferencias.php' method='post'>
        <fieldset>
          ...
          <div class='campo'>
            ...
            <input type="radio" id='color_fondo' name="color" value="#73C6B6"><label>Verde</label><br />
            <input type="radio" id='color_fondo' name="color" value="#E74C3C"><label>Rojo</label><br />
            <input type="radio" id='color_fondo' name="color" value="#5499C7"><label>Azul</label><br />
            <input type="radio" id='color_fondo' name="color" value="#F9E79F"><label>Amarillo</label><br />
          </div>
          <br />
          <div class='campo'>
